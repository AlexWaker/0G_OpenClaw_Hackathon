...
export type NonInteractiveZeroGMemoryRestoreSummary = {
  status: "synced" | "available" | "failed";
...
export function logNonInteractiveOnboardingJson(params: {
  ...
  zeroGMemoryRestore?: NonInteractiveZeroGMemoryRestoreSummary;
  skipSkills?: boolean;
  skipHealth?: boolean;
}) {
  if (!params.opts.json) {
  ...
  writeRuntimeJson(params.runtime, {
    ...
    zeroGMemoryRestore: params.zeroGMemoryRestore,
